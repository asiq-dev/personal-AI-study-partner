"""
Django settings for personal_study_partner project.
...
SECRET_KEY = 'django-insecure-p^mn#iv&qj(5xegoh9#b*v+@c)ur0$@l#b5l27qv!sk-3wnb7b'
...
ROOT_URLCONF = 'personal_study_partner.urls'
...
WSGI_APPLICATION = 'personal_study_partner.wsgi.application'
